...
using MvcApiStudents.Models;
using System.Net.Http;

namespace MvcApiStudents.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                client.BaseAddress = new Uri("http://localhost:63034/api/");
                //HTTP GET
        ...
        public ActionResult create(StudentViewModel student)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri("http://localhost:63034/api/student");
        ...
        {
            var result = new FilePathResult("~/Views/Student/StudentHtml.html", "text/html");
            return result;
        }
